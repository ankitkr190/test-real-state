...
function ChatFooter({ isLoading, onSend }: ChatFooterProps) {
  ...
  return (
    ...
    >
      <div 
        className="backdrop-blur-md shadow-xl border border-white/20 flex flex-col relative overflow-hidden"
        style={{
              ...
              >
                <Image
                  ...
                  style={{
                    ...
                    filter: userInput.trim()?.length === 0 ? 'brightness(0) saturate(0) brightness(0.3) sepia(1) hue-rotate(120deg) saturate(5) brightness(1.2)' : 'brightness(0) invert(1)',
                  }}
                />
              </button>
            </div>
