...
function PermissionPopup({ isVisible, setIsVisible }: PermissionPopupProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-xl max-w-md w-[90%] p-6 shadow-lg relative border border-[#8a7252]/20">
        <h2 className="text-2xl font-semibold text-[#8a7252] mb-4">
          Permissions Required
        </h2>

        <div className="space-y-4 mb-6">
          <div className="flex items-start space-x-3 p-3 rounded-lg bg-[#8a7252]/5">
            <svg
              className="w-6 h-6 text-[#8a7252] mt-1"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              <h3 className="font-medium text-[#8a7252]">Microphone Access</h3>
              <p className="text-sm text-[#8a7252]/80">
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg bg-[#8a7252]/5">
            ...
            <div>
              <h3 className="font-medium text-[#8a7252]">Background Audio</h3>
              <p className="text-sm text-[#8a7252]/80">
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg bg-[#8a7252]/5">
            ...
            <div>
              <h3 className="font-medium text-[#8a7252]">
                Third-party Cookies
              </h3>
              <p className="text-sm text-[#8a7252]/80">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className="flex-1 border border-[#8a7252]/30 text-[#8a7252] px-4 py-2 rounded-lg hover:bg-[#8a7252]/5 transition-colors"
          >
            Reject
          </button>
          <button
            onClick={handleAccept}
            className="flex-1 bg-[#8a7252] text-white px-4 py-2 rounded-lg hover:bg-[#8a7252]/90 transition-colors shadow-sm"
          >
            Accept All
          </button>
        </div>
